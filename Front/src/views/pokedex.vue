...
export default ({
    ...
    methods: {
        ...
        onChangeCat(event){
            ...
            console.log(this.filtre)
            if (this.filtre == "shiny" || this.filtre == "inBox") this.image_folder = "Shiny"
            else this.image_folder = "Pokemon-175px"
            this.load();
        },
        async init() {
        ...
        async load() {
            ...
            if (this.filtre == "inBox"){
                await axios.get(this.urlBack + "getAllPokemonsData/AM")
                .then((response) =>{
